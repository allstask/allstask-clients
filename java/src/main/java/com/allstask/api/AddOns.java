...
import com.allstask.models.AddOn;
import com.allstask.models.AddOnListResponse;
import com.allstask.models.CreateAddOnRequest;
import com.allstask.models.ResolvedEntitlementListResponse;
import com.allstask.models.UpdateAddOnRequest;
...
public class AddOns {
    ...
    public AddOns(AllstaskHttpClient client) {
        this.client = client;
    }
