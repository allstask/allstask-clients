...
import com.allstask.api.BatchJobsListBatchJobsOptions;
...
/**
 * Tests for the Allstask HTTP client using WireMock.
 */
public class AllstaskClientTest {
    @Rule
    public WireMockRule wireMockRule = new WireMockRule(0);

    private AllstaskHttpClient client;
    ...
    public void setUp() {
        ...
        client = new AllstaskHttpClient(baseUrl, headers, Arrays.asList(50L, 100L, 200L));
    }
    ...
    public void testSuccessfulGetRequest() throws IOException, ApiException {
        ...
        verify(getRequestedFor(urlEqualTo("/api/v1/test"))
                ...
                .withHeader("User-Agent", containing("allstask-java/")));
    }
    ...
    public void testListQueryParamIsExploded() throws IOException, ApiException {
        ...
        AllstaskOptions opts = new AllstaskOptions();
        opts.setServerUrl("http://localhost:" + wireMockRule.port());
        Allstask allstask = new Allstask("test-api-key", opts);
        ...
        allstask.getBatchJobs().listBatchJobs(queryOptions);
    ...
    public void testRequestIdHeaderIsAdded() throws IOException, ApiException {
        ...
        verify(getRequestedFor(urlEqualTo("/api/v1/test"))
                .withHeader("x-allstask-req-id", matching("\\d+")));
    }
