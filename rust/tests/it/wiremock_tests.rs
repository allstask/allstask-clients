use allstask_rs::api::{
    BatchJobsListBatchJobsOptions, CustomersListCustomersOptions, Allstask, AllstaskOptions,
};
use allstask_rs::models::BatchJobStatus;
...
fn create_test_client(server_url: String) -> Allstask {
    Allstask::new(
        "test-api-key".to_string(),
        Some(AllstaskOptions {
...
async fn test_create_customer() {
    ...
    let request = allstask_rs::models::CustomerCreateRequest::new(
        allstask_rs::models::Currency::Usd,
        vec![],
...
async fn test_user_agent_is_sent() {
    ...
    assert!(user_agent.to_str().unwrap().starts_with("allstask-rust/"));
